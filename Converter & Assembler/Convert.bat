...
:light
copy Light\*.json ..\Slimefun-Networks-Visualizer\assets\minecraft\optifine\cit\gui
goto start


:dark
copy Dark\*.json ..\Slimefun-Networks-Visualizer\assets\minecraft\optifine\cit\gui
goto start
